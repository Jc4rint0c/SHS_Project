...
class Ghost {
    ...
    ghostBody() {
        ...
        this.ctx.beginPath();
        this.ctx.arc(12, 12, 12, Math.PI, 1.5 * Math.PI, false);
        this.ctx.arc(15, 12, 12, 1.5 * Math.PI, 2 * Math.PI, false);
     ...
     */
    ghostFeet0() {
        this.ctx.lineTo(27, 24);
        this.ctx.lineTo(24, 27);
        this.ctx.lineTo(22.5, 27);
        this.ctx.lineTo(18, 22.5);
        this.ctx.lineTo(13.5, 27);
        this.ctx.lineTo(9, 22.5);
        this.ctx.lineTo(4.5, 27);
     ...
     */
    ghostFeet1() {
        this.ctx.lineTo(27, 27);
        this.ctx.lineTo(22.5, 22.5);
        this.ctx.lineTo(18, 27);
        this.ctx.lineTo(16.5, 27);
        this.ctx.lineTo(13.5, 22.5);
        this.ctx.lineTo(10.5, 27);
        this.ctx.lineTo(9, 27);
        this.ctx.lineTo(4.5, 22.5);
        this.ctx.lineTo(0, 27);
        this.ctx.lineTo(0, 12);
    }
    ...
    ghostNormalFace() {
        ...
        this.ctx.beginPath();
        this.ctx.arc(9 + this.dir.x * 3, 10.5 + this.dir.y * 3, 4.5, 0, 2 * Math.PI);
        this.ctx.arc(18.75 + this.dir.x * 3, 10.5 + this.dir.y * 3, 4.5, 0, 2 * Math.PI);
        this.ctx.fill();

        this.ctx.fillStyle = "rgb(0, 51, 255)";
        this.ctx.beginPath();
        this.ctx.arc(9 + this.dir.x * 6, 10.5 + this.dir.y * 6, 2.25, 0, 2 * Math.PI);
        this.ctx.arc(18.75 + this.dir.x * 6, 10.5 + this.dir.y * 6, 2.25, 0, 2 * Math.PI);
        this.ctx.fill();
    }
    ...
    ghostFrightenFace() {
        ...
        this.ctx.beginPath();
        this.ctx.arc(9, 10.5, 2.25, 0, 2 * Math.PI);
        this.ctx.arc(18.75, 10.5, 2.25, 0, 2 * Math.PI);
        this.ctx.fill();

        this.ctx.strokeStyle = this.getFaceColor();
        this.ctx.beginPath();
        this.ctx.moveTo(4.5, 21);
        this.ctx.lineTo(7.5, 16.5);
        this.ctx.lineTo(10.5, 21);
        this.ctx.lineTo(13.5, 16.5);
        this.ctx.lineTo(16.5, 21);
        this.ctx.lineTo(19.5, 16.5);
        this.ctx.lineTo(22.5, 21);
        this.ctx.stroke();
    }
